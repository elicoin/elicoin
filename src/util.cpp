...
const char * const BITCOIN_CONF_FILENAME = "elicoin.conf";
const char * const BITCOIN_PID_FILENAME = "elicoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Elicoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Elicoin";
#else
    // Unix
    return pathRet / ".elicoin";
#endif
#endif
}
