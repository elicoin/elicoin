...
const char* BIP71_MIMETYPE_PAYMENT = "application/rtidcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/rtidcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/rtidcoin-paymentrequest";
